...
## Python bibliotēkas
Savā projektā es izmantoju tikai Selenium bibliotēku, jo tā var izmantot pārlūkprogrammās - Chrome, Firefox, Opera un citās. Lai uzzinat kā izmantot biblioteku, es paskatijos video, kas bija ierakstīt 5.lekcijas  laikā (https://www.youtube.com/watch?v=t0PBBPuPgaw), ka arī internet resursi (https://selenium-python.readthedocs.io/)
